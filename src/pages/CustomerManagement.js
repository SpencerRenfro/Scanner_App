...
const CustomerForm = ({ customer, onSubmit, onCancel, isEditing }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 my-6 dark:text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border ${errors.firstName ? 'border-red-500 dark:border-red-700' : 'border-gray-300 dark:border-gray-600'} rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white`}
            />
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {error && (
          <div className="bg-red-100 dark:bg-red-900 border border-red-400 dark:border-red-600 text-red-700 dark:text-red-300 px-4 py-3 rounded mb-4">
            ...
            <button
              ...
              className="ml-2 text-red-700 dark:text-red-300 hover:text-red-900 dark:hover:text-red-100 font-bold"
            >
              ×
            </button>
          </div>
        ...
        {showAddForm ? (
          ...
          <div className="mb-6 flex justify-end">
            <button
              ...
              className="px-4 py-2 bg-indigo-600 dark:bg-indigo-700 text-white rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-800 transition-colors flex items-center"
            >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 dark:text-white">
          ...
          {isLoading ? (
            ...
            <p className="text-gray-500 dark:text-gray-400">No customers available.</p>
          )}
        </div>
      </div>
