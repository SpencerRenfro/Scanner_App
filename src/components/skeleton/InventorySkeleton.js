  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center my-6 sm:my-10">
        <div className="h-8 bg-gray-300 rounded w-40 mb-4 sm:mb-0"></div>
            ...
            <table className="table min-w-full text-black">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {Array(5).fill().map((_, index) => (
                  <tr key={index} className="py-4 border-b-2 border-slate-200 cursor-pointer hover:bg-slate-50">
                    ...
                    <td>
                      <div className="flex flex-col sm:flex-row items-start sm:items-center">
                        <div className="h-6 bg-gray-300 rounded w-14 mb-2 sm:mb-0 sm:mr-2"></div>
                        <div className="hidden sm:block h-5 bg-gray-300 rounded w-10"></div>
                      </div>
                    </td>
                    <td className="hidden md:table-cell">
